...
import { LoadingContainer } from "./GameContainer/LoadingContainer/LoadingContainer";
...
export class Sketch_AnimationTest {
  constructor () {
        ...
        this.LoadingContainer = new LoadingContainer(this.app.stage)
